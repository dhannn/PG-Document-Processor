...
void test__add_element1(void *ptr)
{
    ...
    char *expected = "hello";
    char *actual = hashTable[index].tokenList->tokens->token;
...
void test__add_element2(void *ptr)
{
    ...
    char *expected = "world";
    char *actual = hashTable[index].tokenList->tokens->next->token;
...
void test__add_element3(void *ptr)
{
    ...
    char *expected = "!";
    char *actual = hashTable[index].tokenList->tokens->next->next->next->next->token;
